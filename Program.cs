using System;
using System.Linq;
using ZooBitSketch.Acquisition.Banners;
using ZooBitSketch.Acquisition.Shops;
using ZooBitSketch.Acquisition.Workshops;
using ZooBitSketch.Enums;
using ZooBitSketch.Property.PlayerThings;
using ZooBitSketch.Story;
...
namespace ZooBitSketch
{
    internal class Program
    {
        static void Main()
        {
            ...
            MainStory story = MainStory.GetInstance();
